...
abstract class 캐셔 extends 홀직원 {
    ...
    void 계산하기() {
        System.out.println("카드 혹은 현금 계산하기");
    }
}
...
class 홍길동 extends 종업원{
    ...
    요리사 j;  // DIP (의존성 역전원칙)  -->  요리사 추상클래스를 상속하는 장보고, 이순신 클래스를 인스턴스 변수로
              //                          사용하지않고 요리사 추상클래스를 인스턴스 변수로 사용하여 수정을 쉽게 가능
